...
bool TagAndProbe (const char* directory,
  ...
  //TH1D* h_muonMed_IDEffNum_m[3][2];
  //TH1D* h_muonMed_IDEffDen_m[3][2];
  TH1D* h_muonMed_IDEffNum_pt[3][2];
  TH1D* h_muonMed_IDEffDen_pt[3][2];
  TH1D* h_muonMed_IDEffNum_eta[3][2];
  TH1D* h_muonMed_IDEffDen_eta[3][2];
  TH1D* h_muonMed_IDEffNum_fcal[2][2];
  TH1D* h_muonMed_IDEffDen_fcal[2][2];

  //TH1D* h_muonID_MSEffNum_m[3][2];
  //TH1D* h_muonID_MSEffDen_m[3][2];
  TH1D* h_muonID_MSEffNum_pt[3][2];
  TH1D* h_muonID_MSEffDen_pt[3][2];
  TH1D* h_muonID_MSEffNum_eta[3][2];
  TH1D* h_muonID_MSEffDen_eta[3][2];
  TH1D* h_muonID_MSEffNum_fcal[2][2];
  TH1D* h_muonID_MSEffDen_fcal[2][2];
  ...
  for (int iSign : {0,1}) {
    //h_muonMed_IDEffNum_m[0][iSign] = new TH1D (Form ("h_muonMed_IDEffNum_m_pp_sign%i", iSign), ";#it{m}_{tag,probe} [GeV];Counts", 30, 76, 106);
    //h_muonMed_IDEffDen_m[0][iSign] = new TH1D (Form ("h_muonMed_IDEffDen_m_pp_sign%i", iSign), ";#it{m}_{tag,probe} [GeV];Counts", 30, 76, 106);
    //h_muonMed_IDEffNum_m[1][iSign] = new TH1D (Form ("h_muonMed_IDEffNum_m_PbPb18_sign%i", iSign), ";#it{m}_{tag,probe} [GeV];Counts", 30, 76, 106);
    //h_muonMed_IDEffDen_m[1][iSign] = new TH1D (Form ("h_muonMed_IDEffDen_m_PbPb18_sign%i", iSign), ";#it{m}_{tag,probe} [GeV];Counts", 30, 76, 106);
    //h_muonMed_IDEffNum_m[2][iSign] = new TH1D (Form ("h_muonMed_IDEffNum_m_PbPb15_sign%i", iSign), ";#it{m}_{tag,probe} [GeV];Counts", 30, 76, 106);
    //h_muonMed_IDEffDen_m[2][iSign] = new TH1D (Form ("h_muonMed_IDEffDen_m_PbPb15_sign%i", iSign), ";#it{m}_{tag,probe} [GeV];Counts", 30, 76, 106);

    h_muonMed_IDEffNum_pt[0][iSign] = new TH1D (Form ("h_muonMed_IDEffNum_pt_pp_sign%i", iSign), ";#it{p}_{T} [GeV];Counts", 25, 10, 85);
    h_muonMed_IDEffDen_pt[0][iSign] = new TH1D (Form ("h_muonMed_IDEffDen_pt_pp_sign%i", iSign), ";#it{p}_{T} [GeV];Counts", 25, 10, 85);
    h_muonMed_IDEffNum_pt[1][iSign] = new TH1D (Form ("h_muonMed_IDEffNum_pt_PbPb18_sign%i", iSign), ";#it{p}_{T} [GeV];Counts", 25, 10, 85);
    h_muonMed_IDEffDen_pt[1][iSign] = new TH1D (Form ("h_muonMed_IDEffDen_pt_PbPb18_sign%i", iSign), ";#it{p}_{T} [GeV];Counts", 25, 10, 85);
    h_muonMed_IDEffNum_pt[2][iSign] = new TH1D (Form ("h_muonMed_IDEffNum_pt_PbPb15_sign%i", iSign), ";#it{p}_{T} [GeV];Counts", 25, 10, 85);
    h_muonMed_IDEffDen_pt[2][iSign] = new TH1D (Form ("h_muonMed_IDEffDen_pt_PbPb15_sign%i", iSign), ";#it{p}_{T} [GeV];Counts", 25, 10, 85);

    h_muonMed_IDEffNum_eta[0][iSign] = new TH1D (Form ("h_muonMed_IDEffNum_eta_pp_sign%i", iSign), ";#eta;Counts", 25, -2.5, 2.5);
    h_muonMed_IDEffDen_eta[0][iSign] = new TH1D (Form ("h_muonMed_IDEffDen_eta_pp_sign%i", iSign), ";#eta;Counts", 25, -2.5, 2.5);
    h_muonMed_IDEffNum_eta[1][iSign] = new TH1D (Form ("h_muonMed_IDEffNum_eta_PbPb18_sign%i", iSign), ";#eta;Counts", 25, -2.5, 2.5);
    h_muonMed_IDEffDen_eta[1][iSign] = new TH1D (Form ("h_muonMed_IDEffDen_eta_PbPb18_sign%i", iSign), ";#eta;Counts", 25, -2.5, 2.5);
    h_muonMed_IDEffNum_eta[2][iSign] = new TH1D (Form ("h_muonMed_IDEffNum_eta_PbPb15_sign%i", iSign), ";#eta;Counts", 25, -2.5, 2.5);
    h_muonMed_IDEffDen_eta[2][iSign] = new TH1D (Form ("h_muonMed_IDEffDen_eta_PbPb15_sign%i", iSign), ";#eta;Counts", 25, -2.5, 2.5);

    h_muonMed_IDEffNum_fcal[0][iSign] = new TH1D (Form ("h_muonMed_IDEffNum_fcal_PbPb18_sign%i", iSign), ";#Sigma#it{E}_{T}^{FCal} [TeV];Counts", 11, -0.5, 5);
    h_muonMed_IDEffDen_fcal[0][iSign] = new TH1D (Form ("h_muonMed_IDEffDen_fcal_PbPb18_sign%i", iSign), ";#Sigma#it{E}_{T}^{FCal} [TeV];Counts", 11, -0.5, 5);
    h_muonMed_IDEffNum_fcal[1][iSign] = new TH1D (Form ("h_muonMed_IDEffNum_fcal_PbPb15_sign%i", iSign), ";#Sigma#it{E}_{T}^{FCal} [TeV];Counts", 11, -0.5, 5);
    h_muonMed_IDEffDen_fcal[1][iSign] = new TH1D (Form ("h_muonMed_IDEffDen_fcal_PbPb15_sign%i", iSign), ";#Sigma#it{E}_{T}^{FCal} [TeV];Counts", 11, -0.5, 5);

    //h_muonID_MSEffNum_m[0][iSign] = new TH1D (Form ("h_muonID_MSEffNum_m_pp_sign%i", iSign), ";#it{m}_{tag,probe} [GeV];Counts", 30, 76, 106);
    //h_muonID_MSEffDen_m[0][iSign] = new TH1D (Form ("h_muonID_MSEffDen_m_pp_sign%i", iSign), ";#it{m}_{tag,probe} [GeV];Counts", 30, 76, 106);
    //h_muonID_MSEffNum_m[1][iSign] = new TH1D (Form ("h_muonID_MSEffNum_m_PbPb18_sign%i", iSign), ";#it{m}_{tag,probe} [GeV];Counts", 30, 76, 106);
    //h_muonID_MSEffDen_m[1][iSign] = new TH1D (Form ("h_muonID_MSEffDen_m_PbPb18_sign%i", iSign), ";#it{m}_{tag,probe} [GeV];Counts", 30, 76, 106);
    //h_muonID_MSEffNum_m[2][iSign] = new TH1D (Form ("h_muonID_MSEffNum_m_PbPb15_sign%i", iSign), ";#it{m}_{tag,probe} [GeV];Counts", 30, 76, 106);
    //h_muonID_MSEffDen_m[2][iSign] = new TH1D (Form ("h_muonID_MSEffDen_m_PbPb15_sign%i", iSign), ";#it{m}_{tag,probe} [GeV];Counts", 30, 76, 106);

    h_muonID_MSEffNum_pt[0][iSign] = new TH1D (Form ("h_muonID_MSEffNum_pt_pp_sign%i", iSign), ";#it{p}_{T} [GeV];Counts", 25, 10, 85);
    h_muonID_MSEffDen_pt[0][iSign] = new TH1D (Form ("h_muonID_MSEffDen_pt_pp_sign%i", iSign), ";#it{p}_{T} [GeV];Counts", 25, 10, 85);
    h_muonID_MSEffNum_pt[1][iSign] = new TH1D (Form ("h_muonID_MSEffNum_pt_PbPb18_sign%i", iSign), ";#it{p}_{T} [GeV];Counts", 25, 10, 85);
    h_muonID_MSEffDen_pt[1][iSign] = new TH1D (Form ("h_muonID_MSEffDen_pt_PbPb18_sign%i", iSign), ";#it{p}_{T} [GeV];Counts", 25, 10, 85);
    h_muonID_MSEffNum_pt[2][iSign] = new TH1D (Form ("h_muonID_MSEffNum_pt_PbPb15_sign%i", iSign), ";#it{p}_{T} [GeV];Counts", 25, 10, 85);
    h_muonID_MSEffDen_pt[2][iSign] = new TH1D (Form ("h_muonID_MSEffDen_pt_PbPb15_sign%i", iSign), ";#it{p}_{T} [GeV];Counts", 25, 10, 85);

    h_muonID_MSEffNum_eta[0][iSign] = new TH1D (Form ("h_muonID_MSEffNum_eta_pp_sign%i", iSign), ";#eta;Counts", 25, -2.5, 2.5);
    h_muonID_MSEffDen_eta[0][iSign] = new TH1D (Form ("h_muonID_MSEffDen_eta_pp_sign%i", iSign), ";#eta;Counts", 25, -2.5, 2.5);
    h_muonID_MSEffNum_eta[1][iSign] = new TH1D (Form ("h_muonID_MSEffNum_eta_PbPb18_sign%i", iSign), ";#eta;Counts", 25, -2.5, 2.5);
    h_muonID_MSEffDen_eta[1][iSign] = new TH1D (Form ("h_muonID_MSEffDen_eta_PbPb18_sign%i", iSign), ";#eta;Counts", 25, -2.5, 2.5);
    h_muonID_MSEffNum_eta[2][iSign] = new TH1D (Form ("h_muonID_MSEffNum_eta_PbPb15_sign%i", iSign), ";#eta;Counts", 25, -2.5, 2.5);
    h_muonID_MSEffDen_eta[2][iSign] = new TH1D (Form ("h_muonID_MSEffDen_eta_PbPb15_sign%i", iSign), ";#eta;Counts", 25, -2.5, 2.5);

    h_muonID_MSEffNum_fcal[0][iSign] = new TH1D (Form ("h_muonID_MSEffNum_fcal_PbPb18_sign%i", iSign), ";#Sigma#it{E}_{T}^{FCal} [TeV];Counts", 11, -0.5, 5);
    h_muonID_MSEffDen_fcal[0][iSign] = new TH1D (Form ("h_muonID_MSEffDen_fcal_PbPb18_sign%i", iSign), ";#Sigma#it{E}_{T}^{FCal} [TeV];Counts", 11, -0.5, 5);
    h_muonID_MSEffNum_fcal[1][iSign] = new TH1D (Form ("h_muonID_MSEffNum_fcal_PbPb15_sign%i", iSign), ";#Sigma#it{E}_{T}^{FCal} [TeV];Counts", 11, -0.5, 5);
    h_muonID_MSEffDen_fcal[1][iSign] = new TH1D (Form ("h_muonID_MSEffDen_fcal_PbPb15_sign%i", iSign), ";#Sigma#it{E}_{T}^{FCal} [TeV];Counts", 11, -0.5, 5);
  }
  ...
  //    const float nNeutrons = (t->ZdcCalibEnergy_A + t->ZdcCalibEnergy_C) / (2.51);
  ...
  for (int iEvt = 0; iEvt < nEvts; iEvt++) {
    ...
    if (electronTrigger->trigBool) {
      for (int iTag = 0; iTag < t->electron_n; iTag++) {
        if (!t->electron_matched[iTag])
          continue;
        if (!t->electron_lhmedium[iTag])
          continue;
        ...
        for (int iProbe = 0; iProbe < t->electron_n; iProbe++) {
          ...
          if (!isPbPb) {
            h_electronIDEffDen_pt[0]->Fill (t->electron_pt[iProbe]);
            h2_electronIDEffDen_pt_eta[0]->Fill (t->electron_eta[iProbe], t->electron_pt[iProbe]);
            if (t->electron_pt[iProbe] > 20) {
              h_electronIDEffDen_eta[0]->Fill (t->electron_eta[iProbe]);
            }
            if (t->electron_lhloose[iProbe]) {
              h_electronIDEffNum_pt[0]->Fill (t->electron_pt[iProbe]);
              h2_electronIDEffNum_pt_eta[0]->Fill (t->electron_eta[iProbe], t->electron_pt[iProbe]);
              if (t->electron_pt[iProbe] > 20) {
                h_electronIDEffNum_eta[0]->Fill (t->electron_eta[iProbe]);
              }
            }
          }
          else if (isPbPb && !is2015data) {
            h_electronIDEffDen_pt[1]->Fill (t->electron_pt[iProbe]);
            h2_electronIDEffDen_pt_eta[1]->Fill (t->electron_eta[iProbe], t->electron_pt[iProbe]);
            if (t->electron_pt[iProbe] > 20) {
              h_electronIDEffDen_eta[1]->Fill (t->electron_eta[iProbe]);
            }
            if (t->electron_lhloose[iProbe]) {
              h_electronIDEffNum_pt[1]->Fill (t->electron_pt[iProbe]);
              h2_electronIDEffNum_pt_eta[1]->Fill (t->electron_eta[iProbe], t->electron_pt[iProbe]);
              if (t->electron_pt[iProbe] > 20) {
                h_electronIDEffNum_eta[1]->Fill (t->electron_eta[iProbe]);
              }
            }
          }
          else if (isPbPb && is2015data) {
            h_electronIDEffDen_pt[2]->Fill (t->electron_pt[iProbe]);
            h2_electronIDEffDen_pt_eta[2]->Fill (t->electron_eta[iProbe], t->electron_pt[iProbe]);
            if (t->electron_pt[iProbe] > 20) {
              h_electronIDEffDen_eta[2]->Fill (t->electron_eta[iProbe]);
            }
            if (t->electron_lhloose[iProbe]) {
              h_electronIDEffNum_pt[2]->Fill (t->electron_pt[iProbe]);
              h2_electronIDEffNum_pt_eta[2]->Fill (t->electron_eta[iProbe], t->electron_pt[iProbe]);
              if (t->electron_pt[iProbe] > 20) {
                h_electronIDEffNum_eta[2]->Fill (t->electron_eta[iProbe]);
              }
            }
          }
        } // end loop over probe
  ...
  /////////////////////////////////////////////////////////////////////////////////
  //**** Calculate residual centrality dependent electron trigger efficiency ****//
  /////////////////////////////////////////////////////////////////////////////////
      ...
      if (electronTrigger->trigBool) {
        for (int iTag = 0; iTag < t->electron_n; iTag++) {
          ...
          for (int iProbe = 0; iProbe < t->electron_n; iProbe++) {
            ...
            h_electronTrigEffDen_fcal[is2015data]->Fill (fcal_et, effprobe);
            if (t->electron_matched[iProbe])
              h_electronTrigEffNum_fcal[is2015data]->Fill (fcal_et, effprobe);
          } // end loop over probe
          ...
          for (int iProbe = 0; iProbe < t->electron_n; iProbe++) {
            ...
            const float effprobe = (is2015data ? t_electronIDEff_pt_eta_PbPb15->GetEfficiency (t_electronIDEff_pt_eta_PbPb15->FindFixBin (t->electron_eta[iProbe], t->electron_pt[iProbe])) : t_electronIDEff_pt_eta_PbPb18->GetEfficiency (t_electronIDEff_pt_eta_PbPb18->FindFixBin (t->electron_eta[iProbe], t->electron_pt[iProbe])));

            h_electronIDEffDen_fcal[is2015data]->Fill (fcal_et, effprobe);
            if (t->electron_lhloose[iProbe])
              h_electronIDEffNum_fcal[is2015data]->Fill (fcal_et, effprobe);
          } // end loop over probe
        } // end loop over tag
      } // end if electron trigger fired
    }
  ...
  /////////////////////////////////////////////////////////////////////////////////
  //**** Calculate Z boson trigger efficiencies via reweighted distributions ****//
  /////////////////////////////////////////////////////////////////////////////////
  ...
  for (int iEvt = 0; iEvt < nEvts; iEvt++) {
    ...
    if (muonTrigger->trigBool && t->passes_toroid) {
      for (int iM1 = 0; iM1 < t->muon_n; iM1++) {
        ...
        const float eff_m1 = (isPbPb ? (is2015data ? t_muonTrigEff_eta_phi_PbPb15->GetEfficiency (t_muonTrigEff_eta_phi_PbPb15->FindFixBin (t->muon_eta[iM1], InTwoPi (t->muon_phi[iM1]))) : t_muonTrigEff_eta_phi_PbPb18->GetEfficiency (t_muonTrigEff_eta_phi_PbPb18->FindFixBin (t->muon_eta[iM1], InTwoPi (t->muon_phi[iM1])))) : t_muonTrigEff_eta_phi_pp->GetEfficiency (t_muonTrigEff_eta_phi_pp->FindFixBin (t->muon_eta[iM1], InTwoPi (t->muon_phi[iM1]))));
        ...
        for (int iM2 = 0; iM2 < iM1; iM2++) {
          ...
          const float eff_m2 = (isPbPb ? (is2015data ? t_muonTrigEff_eta_phi_PbPb15->GetEfficiency (t_muonTrigEff_eta_phi_PbPb15->FindFixBin (t->muon_eta[iM2], InTwoPi (t->muon_phi[iM2]))) : t_muonTrigEff_eta_phi_PbPb18->GetEfficiency (t_muonTrigEff_eta_phi_PbPb18->FindFixBin (t->muon_eta[iM2], InTwoPi (t->muon_phi[iM2])))) : t_muonTrigEff_eta_phi_pp->GetEfficiency (t_muonTrigEff_eta_phi_pp->FindFixBin (t->muon_eta[iM2], InTwoPi (t->muon_phi[iM2]))));
          ...
          const float eff_z = 1. - (1.-eff_m1)*(1.-eff_m2);
         
          if (!isPbPb) {
            h2_zmumuTrigEffNum_pt_y[0]->Fill (z_tlv.Rapidity (), z_tlv.Pt (), eff_z);
            h2_zmumuTrigEffDen_pt_y[0]->Fill (z_tlv.Rapidity (), z_tlv.Pt ());
          } 
          else if (isPbPb && !is2015data) {
            h2_zmumuTrigEffNum_pt_y[1]->Fill (z_tlv.Rapidity (), z_tlv.Pt (), eff_z);
            h2_zmumuTrigEffDen_pt_y[1]->Fill (z_tlv.Rapidity (), z_tlv.Pt ());
          } 
          else if (isPbPb && is2015data) {
            h2_zmumuTrigEffNum_pt_y[2]->Fill (z_tlv.Rapidity (), z_tlv.Pt (), eff_z);
    ...
    if (electronTrigger->trigBool) {
      for (int iE1 = 0; iE1 < t->electron_n; iE1++) {
        ...
        const float eff_cent = (isPbPb ? h_electronTrigEff_fcal[is2015data]->GetBinContent (h_electronTrigEff_fcal[is2015data]->FindFixBin (fcal_et)) : 1);

        const float eff_e1 = (isPbPb ? (is2015data ? t_electronTrigEff_pt_eta_PbPb15->GetEfficiency (t_electronTrigEff_pt_eta_PbPb15->FindFixBin (t->electron_eta[iE1], t->electron_pt[iE1])) : t_electronTrigEff_pt_eta_PbPb18->GetEfficiency (t_electronTrigEff_pt_eta_PbPb18->FindFixBin (t->electron_eta[iE1], t->electron_pt[iE1]))) : t_electronTrigEff_pt_eta_pp->GetEfficiency (t_electronTrigEff_pt_eta_pp->FindFixBin (t->electron_eta[iE1], t->electron_pt[iE1]))) * eff_cent;
        TLorentzVector e1;
        e1.SetPtEtaPhiM (t->electron_pt[iE1], t->electron_eta[iE1], t->electron_phi[iE1], electron_mass);

        for (int iE2 = 0; iE2 < iE1; iE2++) {
          if (!t->electron_lhloose[iE2])
            continue;
          ...
          const float eff_e2 = (isPbPb ? (is2015data ? t_electronTrigEff_pt_eta_PbPb15->GetEfficiency (t_electronTrigEff_pt_eta_PbPb15->FindFixBin (t->electron_eta[iE2], t->electron_pt[iE2])) : t_electronTrigEff_pt_eta_PbPb18->GetEfficiency (t_electronTrigEff_pt_eta_PbPb18->FindFixBin (t->electron_eta[iE2], t->electron_pt[iE2]))) : t_electronTrigEff_pt_eta_pp->GetEfficiency (t_electronTrigEff_pt_eta_pp->FindFixBin (t->electron_eta[iE2], t->electron_pt[iE2]))) * eff_cent;
          TLorentzVector e2;
          ...
          const float eff_z = (1. - (1.-eff_e1)*(1.-eff_e2));

          if (!isPbPb) {
            h2_zeeTrigEffNum_pt_y[0]->Fill (z_tlv.Rapidity (), z_tlv.Pt (), eff_z);
            h2_zeeTrigEffDen_pt_y[0]->Fill (z_tlv.Rapidity (), z_tlv.Pt ());
          } 
          else if (isPbPb && !is2015data) {
            h2_zeeTrigEffNum_pt_y[1]->Fill (z_tlv.Rapidity (), z_tlv.Pt (), eff_z);
            h2_zeeTrigEffDen_pt_y[1]->Fill (z_tlv.Rapidity (), z_tlv.Pt ());
          } 
          else if (isPbPb && is2015data) {
            h2_zeeTrigEffNum_pt_y[2]->Fill (z_tlv.Rapidity (), z_tlv.Pt (), eff_z);

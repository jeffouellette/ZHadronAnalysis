...
bool IsElectronTrack (TreeVariables* t, const int iTrk, const int iE1, const int iE2) {
  ...
  isElectron = isElectron || (t->trk_pt[iTrk] == t->electron_id_track_pt[iE1] && t->trk_eta[iTrk] == t->electron_id_track_eta[iE1] && t->trk_phi[iTrk] == t->electron_id_track_phi[iE1]);
  ...
  isElectron = isElectron || (t->trk_pt[iTrk] == t->electron_id_track_pt[iE2] && t->trk_eta[iTrk] == t->electron_id_track_eta[iE2] && t->trk_phi[iTrk] == t->electron_id_track_phi[iE2]);
  //isElectron = isElectron || dR < minDR;
...
bool IsMuonTrack (TreeVariables* t, const int iTrk, const int iM1, const int iM2) {
  ...
  isMuon = isMuon || (t->trk_pt[iTrk] == t->muon_id_track_pt[iM1] && t->trk_eta[iTrk] == t->muon_id_track_eta[iM1] && t->trk_phi[iTrk] == t->muon_id_track_phi[iM1]);
  //isMuon = isMuon || dR < minDR;
  //dR = DeltaR (t->trk_eta[iTrk], t->muon_id_track_eta[iM2], t->trk_phi[iTrk], t->muon_id_track_phi[iM2]);
  isMuon = isMuon || (t->trk_pt[iTrk] == t->muon_id_track_pt[iM2] && t->trk_eta[iTrk] == t->muon_id_track_eta[iM2] && t->trk_phi[iTrk] == t->muon_id_track_phi[iM2]);
  //isMuon = isMuon || dR < minDR;

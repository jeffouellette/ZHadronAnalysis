...
void TreeVariables :: SetBranchAddresses () {
  ...
  if (getTracks) {
    ...
    tree->SetBranchStatus ("trk_TightPrimary",      0);
    tree->SetBranchStatus ("trk_d0",                0);
    tree->SetBranchStatus ("trk_d0sig",             0);
    tree->SetBranchStatus ("trk_z0",                0);
    tree->SetBranchStatus ("trk_z0sig",             0);
    tree->SetBranchStatus ("trk_theta",             0);
    tree->SetBranchStatus ("trk_vz",                0);
    tree->SetBranchStatus ("trk_nBLayerHits",       0);
    tree->SetBranchStatus ("trk_nBLayerSharedHits", 0);
    tree->SetBranchStatus ("trk_nPixelHits",        0);
    tree->SetBranchStatus ("trk_nPixelDeadSensors", 0);
    tree->SetBranchStatus ("trk_nPixelSharedHits",  0);
    tree->SetBranchStatus ("trk_nSCTHits",          0);
    tree->SetBranchStatus ("trk_nSCTDeadSensors",   0);
    tree->SetBranchStatus ("trk_nSCTSharedHits",    0);
    tree->SetBranchStatus ("trk_nTRTHits",          0);
    tree->SetBranchStatus ("trk_nTRTSharedHits",    0);
    if (isMC) {
  ...
  if (getElectrons) {
    ...
    tree->SetBranchStatus ("electron_id_track_d0",            0);
    tree->SetBranchStatus ("electron_id_track_d0sig",         0);
    tree->SetBranchStatus ("electron_id_track_z0",            0);
    tree->SetBranchStatus ("electron_id_track_z0sig",         0);
    tree->SetBranchStatus ("electron_id_track_theta",         0);
    tree->SetBranchStatus ("electron_id_track_vz",            0);
    tree->SetBranchStatus ("electron_id_track_tightprimary",  0);
    tree->SetBranchStatus ("electron_id_track_hiloose",       0);
    tree->SetBranchStatus ("electron_id_track_hitight",       0);
  ...
  if (getMuons) {
    ...
    tree->SetBranchAddress ("muon_id_track_d0",             &muon_id_track_d0);
    tree->SetBranchAddress ("muon_id_track_d0sig",          &muon_id_track_d0sig);
    tree->SetBranchAddress ("muon_id_track_z0",             &muon_id_track_z0);
    tree->SetBranchAddress ("muon_id_track_z0sig",          &muon_id_track_z0sig);
    ...
    tree->SetBranchAddress ("muon_ms_track_d0",             &muon_ms_track_d0);
    tree->SetBranchAddress ("muon_ms_track_d0sig",          &muon_ms_track_d0sig);
    tree->SetBranchAddress ("muon_ms_track_z0",             &muon_ms_track_z0);
    tree->SetBranchAddress ("muon_ms_track_z0sig",          &muon_ms_track_z0sig);
    ...
    tree->SetBranchStatus ("muon_id_track_d0sig",         0);
    tree->SetBranchStatus ("muon_id_track_z0",            0);
    tree->SetBranchStatus ("muon_id_track_z0sig",         0);
    ...
    tree->SetBranchStatus ("muon_ms_track_d0sig",         0);
    tree->SetBranchStatus ("muon_ms_track_z0",            0);
    tree->SetBranchStatus ("muon_ms_track_z0sig",         0);

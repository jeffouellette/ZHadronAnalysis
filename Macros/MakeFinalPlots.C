...
void MakeFinalPlots () {
...

  {
    ...
    luPad->cd ();
    tl->SetTextSize (32);
    tl->DrawLatexNDC (0.22, 0.86, "#bf{#it{ATLAS}}");
    tl->SetTextSize (28);
...

  {
    ...
    c3->cd ();
    tl->SetTextSize (30);
    tl->DrawLatexNDC (0.41, 0.930, "#bf{#it{ATLAS}}");
    tl->SetTextSize (28);
...

  {
    ...
    tl->SetTextSize (32);
    tl->DrawLatexNDC (0.26, 0.300, "#bf{#it{ATLAS}}");
    tl->SetTextSize (30);
...

  {
    ...
    tl->SetTextSize (32);
    tl->DrawLatexNDC (0.26, 0.310, "#bf{#it{ATLAS}}");
    tl->SetTextSize (30);
...

  {
    ...
    tl->SetTextSize (30);
    tl->DrawLatexNDC (0.39, 0.900, "#bf{#it{ATLAS}}");
    tl->SetTextSize (28);
...

  {
    ...
    tl->SetTextSize (32);
    tl->DrawLatexNDC (0.34, 0.890, "#bf{#it{ATLAS}}");
    tl->SetTextSize (30);
    tl->DrawLatexNDC (0.34, 0.845, "#it{pp}, #sqrt{s} = 5.02 TeV, 260 pb^{-1}");
    tl->DrawLatexNDC (0.34, 0.798, "Pb+Pb, #sqrt{s_{NN}} = 5.02 TeV, 1.4-1.7 nb^{-1}");

    tl->SetTextSize (27);
    tl->SetTextAlign (21);
    tl->DrawLatexNDC (0.420, 0.74, "15-30");
    tl->DrawLatexNDC (0.517, 0.74, "30-60");
    tl->DrawLatexNDC (0.610, 0.74, ">^{ }60");

    tl->SetTextAlign (11);
    tl->DrawLatexNDC (0.66, 0.74, "#it{p}_{T}^{#it{Z}} [GeV]");
    tl->DrawLatexNDC (0.66, 0.685+0.004, "ATLAS 0-10\%");
    tl->DrawLatexNDC (0.66, 0.630+0.004, "Hybrid Model");

    MakeDataBox (0.665, 0.685+0.015, finalFillColors[3], 0.30, markerStyles[2], 2.4, 0.86, 1.0);
    MakeDataBox (0.571, 0.685+0.015, finalFillColors[2], 0.30, markerStyles[1], 1.8, 0.86, 1.0);
    MakeDataBox (0.477, 0.685+0.015, finalFillColors[1], 0.30, markerStyles[0], 1.8, 0.86, 1.0);
    MakeTheoryBox (0.665, 0.630+0.015, finalFillColors[3], 0.30, 0.86, 1.0);
    MakeTheoryBox (0.571, 0.630+0.015, finalFillColors[2], 0.30, 0.86, 1.0);
    MakeTheoryBox (0.477, 0.630+0.015, finalFillColors[1], 0.30, 0.86, 1.0);
    MakeTheoryLine (0.665, 0.630+0.015, finalFillColors[3], 0.86);
    MakeTheoryLine (0.571, 0.630+0.015, finalFillColors[2], 0.86);
    MakeTheoryLine (0.477, 0.630+0.015, finalFillColors[1], 0.86);
...

  {
    ...
    tl->DrawLatexNDC (0.66, 0.74, "#it{p}_{T}^{#it{Z}} [GeV]");
    tl->DrawLatexNDC (0.66, 0.685+0.004, "ATLAS 0-10\%");
    tl->DrawLatexNDC (0.66, 0.630+0.004, "JEWEL");
...

  {
    ...
    tl->SetTextSize (27);
    tl->SetTextAlign (21);
    tl->DrawLatexNDC (0.390, 0.74, "15-30");
    tl->DrawLatexNDC (0.487, 0.74, "30-60");
    tl->DrawLatexNDC (0.580, 0.74, ">^{ }60");

    tl->SetTextAlign (11);
    tl->DrawLatexNDC (0.63, 0.74, "#it{p}_{T}^{#it{Z}} [GeV]");
    tl->DrawLatexNDC (0.63, 0.685+0.004, "ATLAS 0-10\%");
    tl->DrawLatexNDC (0.63, 0.630+0.004, "SCET_{G} (#it{g}^{ }=^{ }2.0#pm0.2)");

    MakeDataBox (0.635, 0.685+0.015, finalFillColors[3], 0.30, markerStyles[2], 2.4, 0.86, 1.0);
    MakeDataBox (0.541, 0.685+0.015, finalFillColors[2], 0.30, markerStyles[1], 1.8, 0.86, 1.0);
    MakeDataBox (0.447, 0.685+0.015, finalFillColors[1], 0.30, markerStyles[0], 1.8, 0.86, 1.0);
    MakeTheoryBox (0.635, 0.630+0.015, finalFillColors[3], 0.30, 0.86, 1.0);
    MakeTheoryBox (0.541, 0.630+0.015, finalFillColors[2], 0.30, 0.86, 1.0);
    MakeTheoryBox (0.447, 0.630+0.015, finalFillColors[1], 0.30, 0.86, 1.0);
    MakeTheoryLine (0.635, 0.630+0.015, finalFillColors[3], 0.86);
    MakeTheoryLine (0.541, 0.630+0.015, finalFillColors[2], 0.86);
    MakeTheoryLine (0.447, 0.630+0.015, finalFillColors[1], 0.86);
...

  {
    ...
    tl->SetTextSize (32);
    tl->DrawLatexNDC (0.34, 0.890, "#bf{#it{ATLAS}} Internal");
    tl->SetTextSize (30);
    tl->DrawLatexNDC (0.34, 0.845, "#it{pp}, #sqrt{s} = 5.02 TeV, 260 pb^{-1}");
    tl->DrawLatexNDC (0.34, 0.798, "Pb+Pb, #sqrt{s_{NN}} = 5.02 TeV, 1.4-1.7 nb^{-1}");
    ...
    tl->DrawLatexNDC (0.66, 0.74, "#it{p}_{T}^{#it{Z}} [GeV]");
    tl->DrawLatexNDC (0.66, 0.685+0.004, "ATLAS 0-10\%");
    tl->DrawLatexNDC (0.66, 0.630+0.004, "CoLBT-hydro");
    ...
    c11->SaveAs (Form ("%s/FinalPlots/iaa_ptch_colbtComp.pdf", plotPath.Data ()));
  }
...

  {
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    TCanvas* c12 = new TCanvas ("c_mean_pTch_comb", "", 800, 800);
    c12->cd ();
    ...
    tl->SetTextAlign (11);
    tl->SetTextSize (32);
    tl->DrawLatexNDC (0.22, 0.87, "#bf{#it{ATLAS}}");
    ...
    c12->SaveAs (Form ("%s/FinalPlots/mean_ptch.pdf", plotPath.Data ()));
  }
...

  {
    ...
    tl->SetTextSize (28);
    tl->DrawLatexNDC (0.20, 0.14, "#bf{#it{ATLAS}}");
    tl->SetTextSize (28);
...

  {
    ...
    tl->DrawLatexNDC (0.18, 0.838, "Pb+Pb, #sqrt{s_{NN}} = 5.02 TeV, 1.4-1.7 nb^{-1}");
...

  {
    ...
    tl->DrawLatexNDC (0.33, 0.798, "Pb+Pb, #sqrt{s_{NN}} = 5.02 TeV, 1.4-1.7 nb^{-1}");
...

  {
    ...
    tl->SetTextSize (32);
    tl->DrawLatexNDC (0.33, 0.890, "#bf{#it{ATLAS}}");
    tl->SetTextSize (30);
    tl->DrawLatexNDC (0.33, 0.845, "#it{pp}, #sqrt{s} = 5.02 TeV, 260 pb^{-1}");
    tl->DrawLatexNDC (0.33, 0.798, "Pb+Pb, #sqrt{s_{NN}} = 5.02 TeV, 1.4-1.7 nb^{-1}");
...

  {
    ...
    tl->SetTextSize (25);
    tl->DrawLatexNDC (0.43-0.009, 0.760-0.010, "ATLAS 0-10\%, #it{p}_{T}^{#it{Z}} > 60 GeV");
    tl->DrawLatexNDC (0.43-0.009, 0.715-0.010, "Hybrid Model");
    tl->DrawLatexNDC (0.78-0.009, 0.715-0.010, "CoLBT-hydro");
    tl->DrawLatexNDC (0.43-0.009, 0.670-0.010, "SCET_{G} (#it{g}^{ }=^{ }2.0#pm0.2)");
    tl->DrawLatexNDC (0.78-0.009, 0.670-0.010, "JEWEL");
...

  {
    ...
    tl->SetTextSize (25);
    tl->DrawLatexNDC (0.32-0.007, 0.296-0.010, "ATLAS 0-10\%, 15 < #it{p}_{T}^{#it{Z}} < 30 GeV");
    tl->DrawLatexNDC (0.32-0.007, 0.249-0.010, "Hybrid Model");
    tl->DrawLatexNDC (0.32-0.007, 0.202-0.010, "SCET_{G} (#it{g}^{ }=^{ }2.0#pm0.2)");
    tl->DrawLatexNDC (0.69-0.007, 0.202-0.010, "JEWEL");

    MakeDataBox   (0.33, 0.296, finalFillColors[1], 0.30, markerStyles[0], 1.8);
    MakeTheoryBox (0.33, 0.249, hybridColor, hybridAlpha);
    MakeTheoryLine (0.33, 0.249, hybridColor);
    MakeTheoryBox (0.33, 0.202, scetgColor, scetgAlpha);
    MakeTheoryLine (0.33, 0.202, scetgColor);
    MakeTheoryBox (0.70, 0.202, jewelColor, jewelAlpha);
    MakeTheoryLine (0.70, 0.202, jewelColor);
...

  {
    ...
    tl->SetTextSize (25);
    tl->DrawLatexNDC (0.32-0.007, 0.296-0.010, "ATLAS 0-10\%, 30 < #it{p}_{T}^{#it{Z}} < 60 GeV");
    tl->DrawLatexNDC (0.32-0.007, 0.249-0.010, "Hybrid Model");
    tl->DrawLatexNDC (0.69-0.007, 0.249-0.010, "CoLBT-hydro");
    tl->DrawLatexNDC (0.32-0.007, 0.202-0.010, "SCET_{G} (#it{g}^{ }=^{ }2.0#pm0.2)");
    tl->DrawLatexNDC (0.69-0.007, 0.202-0.010, "JEWEL");

    MakeDataBox   (0.33, 0.296, finalFillColors[2], 0.30, markerStyles[1], 1.8);
    MakeTheoryBox (0.33, 0.249, hybridColor, hybridAlpha);
    MakeTheoryLine (0.33, 0.249, hybridColor);
    MakeTheoryBox (0.70, 0.249, colbtColor, colbtAlpha);
    MakeTheoryLine (0.70, 0.249, colbtColor);
    MakeTheoryBox (0.33, 0.202, scetgColor, scetgAlpha);
    MakeTheoryLine (0.33, 0.202, scetgColor);
    MakeTheoryBox (0.70, 0.202, jewelColor, jewelAlpha);
    MakeTheoryLine (0.70, 0.202, jewelColor);
...

  {
    ...
    tl->SetTextSize (25);
    tl->DrawLatexNDC (0.32-0.007, 0.296-0.010, "ATLAS 0-10\%, #it{p}_{T}^{#it{Z}} > 60 GeV");
    tl->DrawLatexNDC (0.32-0.007, 0.249-0.010, "Hybrid Model");
    tl->DrawLatexNDC (0.69-0.007, 0.249-0.010, "CoLBT-hydro");
    tl->DrawLatexNDC (0.32-0.007, 0.202-0.010, "SCET_{G} (#it{g}^{ }=^{ }2.0#pm0.2)");
    tl->DrawLatexNDC (0.69-0.007, 0.202-0.010, "JEWEL");

    MakeDataBox   (0.33, 0.296, finalFillColors[3], 0.30, markerStyles[2], 2.4);
    MakeTheoryBox (0.33, 0.249, hybridColor, hybridAlpha);
    MakeTheoryLine (0.33, 0.249, hybridColor);
    MakeTheoryBox (0.70, 0.249, colbtColor, colbtAlpha);
    MakeTheoryLine (0.70, 0.249, colbtColor);
...

  {
    ...
    ulPad->cd ();
    tl->SetTextSize (40);
    tl->DrawLatexNDC (0.23, 0.750, "#bf{#it{ATLAS}}");
    tl->SetTextSize (32);
    tl->DrawLatexNDC (0.23, 0.660, "#it{p}_{T}^{#it{Z}} > 60 GeV");
    tl->SetTextSize (32);
    tl->DrawLatexNDC (0.32, (0.580-0.020), "0-30% Pb+Pb");
    tl->DrawLatexNDC (0.32, (0.500-0.020), "#it{pp}");
    MakeDataBox   (0.33, (0.580), finalFillColors[3], 0.30, markerStyles[2], 2.4, 1., 0.6/(1.-yPadCUMiddle));
    MakeDataBox   (0.33, (0.500), finalFillColors[0], 0.30, kOpenCircle, 1.8, 1., 0.6/(1.-yPadCUMiddle));

    clPad->cd ();
    tl->SetTextSize (32);
    tl->DrawLatexNDC (0.23, (0.660+0.09)/(1.-tMargin), "30 < #it{p}_{T}^{#it{Z}} < 60 GeV");
    tl->SetTextSize (32);
    tl->DrawLatexNDC (0.32, (0.580-0.020+0.09)/(1.-tMargin), "0-30% Pb+Pb");
    tl->DrawLatexNDC (0.32, (0.500-0.020+0.09)/(1.-tMargin), "#it{pp}");
    MakeDataBox   (0.33, (0.580+0.09)/(1.-tMargin), finalFillColors[2], 0.30, markerStyles[1], 1.8, 1., 0.6/(yPadCUMiddle-yPadDCMiddle));
    MakeDataBox   (0.33, (0.500+0.09)/(1.-tMargin), finalFillColors[0], 0.30, kOpenCircle, 1.8, 1., 0.6/(yPadCUMiddle-yPadDCMiddle));

    dlPad->cd ();
    tl->SetTextSize (32);
    tl->DrawLatexNDC (0.23, (0.660+0.09)/(1.-tMargin) * (1.-bMargin) + bMargin, "15 < #it{p}_{T}^{#it{Z}} < 30 GeV");
    tl->SetTextSize (32);
    tl->DrawLatexNDC (0.32, (0.580-0.020+0.09)/(1.-tMargin) * (1.-bMargin) + bMargin, "0-30% Pb+Pb");
    tl->DrawLatexNDC (0.32, (0.500-0.020+0.09)/(1.-tMargin) * (1.-bMargin) + bMargin, "#it{pp}");
    MakeDataBox   (0.33, (0.580+0.09)/(1.-tMargin) * (1.-bMargin) + bMargin, finalFillColors[1], 0.30, markerStyles[0], 1.8, 1., 0.6/yPadDCMiddle);
    MakeDataBox   (0.33, (0.500+0.09)/(1.-tMargin) * (1.-bMargin) + bMargin, finalFillColors[0], 0.30, kOpenCircle, 1.8, 1., 0.6/yPadDCMiddle);

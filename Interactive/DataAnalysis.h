...
class DataAnalysis : public Analysis {
  ...
  public:
  TH1I* eventSelectionHist = new TH1I ("eventSelectionHist", "", 10, -0.5, 9.5);
...
void DataAnalysis::Execute () {
  ...
  PbPbEventReweights = (TH3D*)eventWeightsFile->Get ("PbPbEventReweights_data");
  ppEventReweights = (TH1D*)eventWeightsFile->Get ("ppEventReweights_data");

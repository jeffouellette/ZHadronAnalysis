...
void PlotPullDist (const PhysicsAnalysis* a, Systematic* sys = nullptr, const bool useTrkPt = true) {
  ...
  TH1D* h_pull = new TH1D (Form ("h_pull_%s", useTrkPt ? "pTch" : "xhZ"), Form (";Pull = (Y^{#it{ee}} (%s) - Y^{#it{#mu#mu}} (%s)) / #sigma;Entries", useTrkPt ? "#it{p}_{T}^{ch}" : "#it{x}_{hZ}", useTrkPt ? "#it{p}_{T}^{ch}" : "#it{x}_{hZ}"), 20, -5, 5);
  ...
  TH1D* h_pull_expected = new TH1D (Form ("h_pull_expected_%s", useTrkPt ? "pTch" : "xhZ"), Form (";Pull = (Y^{#it{ee}} (%s) - Y^{#it{#mu#mu}} (%s)) / #sigma;Entries", useTrkPt ? "#it{p}_{T}^{ch}" : "#it{x}_{hZ}", useTrkPt ? "#it{p}_{T}^{ch}" : "#it{x}_{hZ}"), 20, -5, 5);

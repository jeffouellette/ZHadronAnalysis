...
const double centBins[4] = {148.625, 1378.92, 2995.94, 5000}; // updated 2015 recommendations, new Glauber MC
const int centCuts[4]    = {70,     30,     10,      0};
...
const float superFineCentBins[69] = {
    66.402, // 80%
    //72.411, // 79%
    78.834, // 78%
    //85.729, // 77%

...
for iSeed in {160..400}
do
  time ./bin/gen $((iSeed+8000)) 30 60 10000 318 output/seed${iSeed}_iPtZ4_iCent3.root > log/seed${iSeed}_iPtZ4_iCent3.log 2> errors/seed${iSeed}_iPtZ4_iCent3.err &
  if [[ $((iSeed % 8)) -eq 7 ]]
  then
    wait
  fi
